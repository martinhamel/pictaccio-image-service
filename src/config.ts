...
export const config: ConfigSchema = {
    ...
    app: {
        ...
        dirs: {
            thumbnails: join(process.env.PUBLIC_DIR, 'thumbs'),
        },
        logging: {
    ...
    saml: {
        ...
        serviceProviderPrivateKey: formatPEMString(process.env.SAML_SERVICE_PROVIDER_PRIVATE_KEY),
        serviceProviderCertificate: formatPEMString(process.env.SAML_SERVICE_PROVIDER_CERTIFICATE),
